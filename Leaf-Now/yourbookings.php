...
<html lang="en">
  ...
  <strong>Success!</strong> Seed removed from Bookings.
...
<div class="container my-4">
  ...
  <div id = "reciept-print">
    <table class="table" id="myTable">
      <thead>
        <tr>
          <th scope="col" style="color: black;">Seed Photo</th>
          ...
          <th scope="col" style="color: black;">Seed id</th>
      ...
      <tbody>
        <?php 
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            onclick='GeneratePdf()' value='GeneratePdf'></td>
          </tr>";
        } 
          ?>
       </tbody>
...
cancel = document.getElementsByClassName('cancel');
   ...
   <script>          
        ...
        function GeneratePdf() {
            var element = document.getElementById('reciept-print');
            html2pdf(element);
        }
    </script>
