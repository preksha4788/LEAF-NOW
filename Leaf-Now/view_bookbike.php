...
<link href="https://fonts.googleapis.com/css2?family=Lobster&display=swap" rel="stylesheet">
    ...
    <style>
     body {
          /* The image used */
          background-image: url("seed3.jpg");
  ...
  <strong>Success!</strong> Seed booking successful.
...
<h3 class= "text-center my-4" style="color: white;font-size: 250%;">Available Seed Details</h3>
      ...
      <tbody>
        <?php 
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            <td> <button class='book btn btn-sm btn-primary' id=d".$row['bike_no'].">Buy</button>  </td>
          </tr>";
        } 
          ?>
       </tbody>
...
books = document.getElementsByClassName('book');
    Array.from(books).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to buy this seed!?")) {
          console.log("yes");
